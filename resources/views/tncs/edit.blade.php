    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
              <label for="notes" class="fw-bold mt-3">Term And Condition</label>
              <div class="input-group input-group-outline w-100">
                  <textarea class="form-control w-100" name="narasi" id="notes" value="{{ old('narasi') ?? $item->narasi }}" placeholder="Masukkan Notes" required>{{$item->narasi}}</textarea>
              </div>
          </form>
          @endforeach
          </div>
